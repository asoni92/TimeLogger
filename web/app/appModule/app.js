...
var concurApp = angular.module('concurApp', ['ngResource', 'ui.router', 'ngRoute', 'LocalStorageModule', 'angular.chosen',
    ...
    'uiSwitch', 'ui.keypress', 'ui.grid.resizeColumns', 'ui.grid.pagination', 'ui.bootstrap', 'ui.utils','ngFileUpload','ui.bootstrap','btorfs.multiselect','jlareau.pnotify', 'pascalprecht.translate','am.multiselect', 'angular.css.injector','ngCookies','ipCookie','multipleSelect', 'rt.asyncseries', 'nvd3'])
